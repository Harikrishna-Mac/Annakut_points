...
//           setMessage('❌ Unable to start camera. Please allow camera permissions and try again.');
//           setIsScanning(false);
//         }
//       } else {
...
//       if (response.ok) {
//         setMessage(`✅ Successfully ${scanType === 'add' ? 'added' : 'deducted'} 10 points for ${qrData}! New balance: ${result.newPoints}`);
//       } else {
